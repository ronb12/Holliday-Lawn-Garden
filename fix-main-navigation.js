...
// Main navigation pages that need hamburger menu fixes
...
console.log('🔧 Fixing Hamburger Menu on Main Navigation Pages...\n');
...
// Fix main navigation pages
mainNavigationPages.forEach(fixHamburgerMenu);

console.log('\n🎉 Hamburger menu fixes completed on main navigation pages!');
console.log('Run the test again to verify the fixes.'); 