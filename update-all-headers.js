...
// Main pages that need header updates
const mainPages = [
    'about.html',
    'services.html', 
    'education.html',
...
// The correct header structure from FAQ page
const correctHeader = `  <header class="main-header">
    <div class="logo">
      <a href="index.html">
        <picture>
...
function updateHeaderInFile(filePath) {
    try {
        ...
        const newContent = beforeHeader + correctHeader + afterHeader;
...
console.log('🔄 Updating headers in all main pages...\n');

let updatedCount = 0;
for (const page of mainPages) {
    if (fs.existsSync(page)) {
        if (updateHeaderInFile(page)) {
            updatedCount++;
        }
    } else {
