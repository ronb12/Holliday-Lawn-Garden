...
// Critical pages that need hamburger menu fixes
const criticalPages = [
    'index.html',
    'about.html', 
    'services.html',
...
console.log('🔧 Fixing Hamburger Menu on Critical Pages...\n');
...
// Fix critical pages
criticalPages.forEach(fixHamburgerMenu);

console.log('\n🎉 Hamburger menu fixes completed!');
